...
function [settings]= settings()
    ...
    settings.message ='Click any key when you''re ready for the next one!';
    
    %settings.message2 ='Listen to the other person, then answer as naturally as possible. Press any key when you're done!';
    settings.message2 ='Press any key when you''re ready to listen to the first sentence!';
    ...
    % settings.message5 = 'Would you like to replay this dialogue?';
    settings.message5 = 'Press any key to play again!';
