 ...
 function [response keypress] = askquestion(ws, settings, trial, qNumber)
 ...
 accepted_keys=settings.acceptedkeys;
        ...
        if (strcmp(qType,'yn'))
            ...
            Screen('Flip',ws.ptr);
            [pressed_key keypress] = getKeyResponse(accepted_keys,inf);
        ...
        elseif (strcmp(qType,'jm'))
            ...
            Screen('Flip',ws.ptr);
            [pressed_key keypress] = getResponseKeypad(accepted_keys,inf);
            FlushEvents('keyDown');
            pressed_key=str2num(pressed_key);
       ...
       elseif (strcmp(qType,'ryn'))
             
           rand_index=randperm(6);
           rand=rand_index(1);
           if rand==1
               quText=[quText ' ' trial.choice1];
           elseif rand==2
               quText=[quText ' ' trial.choice2];
           elseif rand==3
               quText=[quText ' ' trial.choice3];
           elseif rand==4
               quText=[quText ' ' trial.choice4];
           elseif rand==5
               quText=[quText ' ' trial.choice5];
           elseif rand==6
               quText=[quText ' ' trial.choice6];
           end
