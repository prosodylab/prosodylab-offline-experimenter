function [recordedaudio]=RecordSound(contextFile, context, text, display, screen, settings)
...
if ~isempty(screen)
    ...
    if display
        ...
        DrawFormattedText(screen.ptr, double(text),50,600,0,settings.textwidth,[],[],1.2);
